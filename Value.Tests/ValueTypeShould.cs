// // --------------------------------------------------------------------------------------------------------------------
// // <copyright file="ValueTypeShould.cs">
// //     Copyright 2016
...
namespace Value.Tests
{
    ...
    public class ValueTypeShould
    {
        ...
        [Test]
        public void Distinguish_a_value_type_from_null()
        {
            var amount = new Amount(new decimal(50.3), Currency.Dollar);
        ...
        [Test]
        public void Distinguish_a_value_type_instance_from_WTF_is_this_other_type()
        {
            var amount = new Amount(new decimal(50.3), Currency.Dollar);
        ...
        [Test]
        public void Find_equals_2_different_instances_of_ValueType_with_same_values()
        {
            var amount = new Amount(new decimal(50.3), Currency.Dollar);
        ...
        [Test]
        public void Retrieve_properly_implemented_derived_value_type_with_same_values_in_a_set()
        {
            var itemPrice = new ItemPrice("movie", new decimal(50.3), Currency.Dollar);
        ...
        [Test]
        public void Retrieve_value_type_with_same_values_in_a_set()
        {
            var amount = new Amount(new decimal(50.3), Currency.Dollar);
        ...
        [Test]
        public void Work_with_null_when_using_equality_operator()
        {
            Amount amount1 = null;
            Amount amount2 = null;
