...
namespace Value.Tests
{
    ...
    internal class AmountTests
    {
        ...
        public void Should_throw_exception_when_trying_to_add_Amounts_with_different_currencies()
        {
            ...
            Check.ThatCode(() => firstAmount.Add(secondAmount)).Throws<InvalidOperationException>().WithMessage("Can't add amounts with different currencies: Amount= 1 Euro and other amount= 1 Yuan.");
        }
    }
}