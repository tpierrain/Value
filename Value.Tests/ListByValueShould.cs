// // --------------------------------------------------------------------------------------------------------------------
// // <copyright file="ListByValueShould.cs">
// //     Copyright 2016
...
namespace Value.Tests
{
    ...
    [TestFixture]
    public class ListByValueShould
    {
        [Test]
        public void Accept_list_as_constructor_argument()
        {
        ...
        [Test]
        public void Change_its_hashcode_everytime_the_list_is_updated()
        {
        ...
        [Test]
        public void Consider_Equals_two_instances_with_same_reference_types_elements_in_same_order()
        {
        ...
        [Test]
        public void Consider_Equals_two_instances_with_same_ValueType_elements_in_same_order()
        {
        ...
        [Test]
        public void Properly_expose_IEnumerable()
        {
            var list = new ListByValue<Card>() { Card.Parse("QC"), Card.Parse("TS") };
        ...
        [Test]
        public void Properly_expose_IndexOf()
        {
            var list = new ListByValue<Card>() { Card.Parse("QC"), Card.Parse("TS") };
